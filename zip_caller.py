"""
File Name: ZIP_Caller.py
Description: A highly sensitive copy number variation detector designed for low-coverage sequencing data, serving as a preliminary step for PGcnv.
Author: Xavier Xue
Python Version: 3.7
"""
